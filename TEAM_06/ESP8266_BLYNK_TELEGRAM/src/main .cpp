...
#define BLYNK_AUTH_TOKEN "xx" // ae ai làm được cái blynk thì điền hộ vào đống này với
...
void setLed(bool state, bool pushToBlynk = true)
{
  ledState = state;
