...
#define BLYNK_TEMPLATE_ID "TMPL63RHvOrVr"
#define BLYNK_TEMPLATE_NAME "BlynkAPI"
#define BLYNK_AUTH_TOKEN "nwuNQJd7psuRF7kovVV3WPr4TJm90s9n"
...
#define OPENWEATHERMAP_KEY "e5282b8cdd955daa78f0aebf74ec76f1" //Thay KEY của bạn vào đây
...
void uptimeBlynk(){
  ...
  if (millis() - lastTime < 1000) return; // mỗi 1 giây
  lastTime = millis();

  ulong value = millis() / 1000; // thời gian ESP32 chạy (giây)
