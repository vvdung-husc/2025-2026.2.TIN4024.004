...
#define BLYNK_TEMPLATE_ID "TMPL60t0lAMno"
#define BLYNK_TEMPLATE_NAME "Blynk"
#define BLYNK_AUTH_TOKEN "lMP8G-Y-eHj976AFgJ-d90kS1dy2yNsM"
...
void setup() {
  ...
  Blynk.begin(BLYNK_AUTH_TOKEN, ssid, pass, "blynk.cloud", 80); //Kết nối đến mạng WiFi
