...
#define BOTtoken "8767116549:AAFxFG-CoOsDZ-B40FYYKpLYlsy9lATPY4Y"  // Copy đủ cả số và chữ từ BotFather
#define GROUP_ID " -1003732198123"    // ID nhóm (thường bắt đầu bằng -100)
...
void handleNewMessages(int numNewMessages) {
  for (int i = 0; i < numNewMessages; i++) {
    ...
    if (text == "/led_on") {
      ...
      bot.sendMessage(chat_id, "Chào Thanh Bình! Hệ thống sẵn sàng. Hãy dùng Menu lệnh.", "");
    }
  }
}
