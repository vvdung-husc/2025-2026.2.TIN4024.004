...
#define BLYNK_TEMPLATE_ID "TMPL6ZXK_kNFP"
#define BLYNK_TEMPLATE_NAME "ESP32 TM1637"
#define BLYNK_AUTH_TOKEN "eY9UsOEOV8HONcz1SOs7_XpBAoDPzFCD"
...
void updateBlueButton(){
  ...
  if (!blueButtonON){
    ...
    blueButtonON = true;
    Blynk.virtualWrite(V0, blueButtonON);//Gửi giá trị lên chân ảo V1 trên ứng dụng Blynk.
  }
  else {
...
BLYNK_WRITE(V0) { //virtual_pin định nghĩa trong ứng dụng Blynk
